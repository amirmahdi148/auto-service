...
export const FavoritesPage = () => {
    const [selectedCenter, setSelectedCenter] = useState<typeof FAVORITE_CENTERS[0] | null>(null);
                ...
                {FAVORITE_CENTERS.map((center) => (
                    <div key={center.id} className="flex flex-col bg-surface border border-outline-variant rounded-2xl p-5 hover:-translate-y-1 hover:shadow-[0_8px_24px_-8px_rgba(0,0,0,0.1)] transition-all duration-300 group">
                        <div className="flex items-start justify-between mb-4">
                            ...
                            <button className="text-secondary hover:bg-secondary/10 w-9 h-9 rounded-full flex items-center justify-center transition-colors cursor-pointer shrink-0">
