...
import { X, CalendarDays, Clock, CarFront, Wrench, Search, MapPin, Store } from "lucide-react";
                        ...
                        <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <select 
                                    ...
                                    className="w-full h-11 px-4 rounded-xl bg-surface border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary outline-none text-on-surface text-label-md"
                                >
                                    <option value="">یک خودرو انتخاب کنید...</option>
                                    <option value="پژو ۲۰۶ - ایران ۱۱">پژو ۲۰۶ - ایران ۱۱</option>
                                    <option value="دنا پلاس - ایران ۲۲">دنا پلاس - ایران ۲۲</option>
                                </select>
                            </div>
                ...
                <div className="flex items-center justify-between px-6 py-4 border-t border-outline-variant shrink-0 bg-surface">
                    ...
                    {step < 4 ? (
                        ...
                        <button 
                            onClick={() => {
                                onClose();
                                setTimeout(() => setStep(1), 300); // reset after transition
                            }}
                            className="h-11 px-6 rounded-xl bg-primary text-on-primary hover:bg-primary-container transition-colors text-label-lg font-bold cursor-pointer"
                        >
                            تایید و ثبت نهایی
                        </button>
                    )}
