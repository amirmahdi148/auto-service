...
export const CtaSection = () => {
    ...
    return (
        <div ref={ref} className={`flex flex-col lg:flex-row gap-12 px-8 py-16 items-center mb-16 rounded-[3rem] bg-primary text-on-primary shadow-2xl relative overflow-hidden transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} id="professionals">
